...
A plain-language summary of the major work on the team website ([robot.mbhs.edu](http://robot.mbhs.edu)), written for team leaders. For the full technical detail, see [CHANGELOG.md](CHANGELOG.md) and [RUNBOOK.md](RUNBOOK.md) in this folder.
...
- **General cleanup.** Updated stale pages, fixed broken links, moved thousands of unneeded Grav 1.7 files into the /archive folder, etc.
