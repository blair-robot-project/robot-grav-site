...
- **Improved search visibility (SEO).** Added meta tags, per-page descriptions, and a sitemap. A follow-up audit (mid-July) found and fixed several more issues, and adding alt-text to homepage.
