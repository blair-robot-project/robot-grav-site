...
**Status: filed 2026-07-21, Phases 0-1 done 2026-07-22 (parallel copy stood up, Quark 2 installed, `mod-quark-2` child theme rendering it stock, Brad-verified via SSH tunnel). Phase 2 (porting each custom piece) not yet started.** This is the concrete parallel-build-then-cutover plan for whenever the team decides to act on it.
