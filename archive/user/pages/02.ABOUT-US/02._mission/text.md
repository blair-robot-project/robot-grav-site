...
text_align: justify
menu: 'Text: Top'
media_order: 'Logo Primary.svg'
---

Established in 1999, The Blair Robot Project—FRC Team 449—is composed of students and mentors from Montgomery Blair High School and the surrounding area. 

Team 449 participates in the [_FIRST_ Robotics Competition](https://www.firstinspires.org/programs/frc/), the highest echelon of _FIRST_ events, along with more than 3,000 high-school teams around the globe. Each year, _FIRST_ issues a new game for the season, and each team designs, fabricates, and programs a robot to compete in it. We compete in the [_FIRST_ Chesapeake District](https://www.firstchesapeake.org/frc).
